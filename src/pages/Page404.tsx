...
export default function Page404() {
    ...
    return (
        <PageStyled className=' w-full h-screen flex justify-center items-center px-9 sm:px-6 md:px-32 '>
            <div className=' w-6/12 text-left mx-auto '>
                ...
                <div className=' mt-10'>
                    <div
                        className={`btn mg-btn text-white ml-auto cursor-pointer text-base  transition duration-150 ease-in-out`}
                        onClick={() => {
                            navigate(`/`)
                        }}>
                        Back to Home Page
            ...
            <div className=' w-6/12 text-left'>
                <img src={AssetsImgs.img404} className=" w-4/6 inline-block object-cover"></img>
            </div>
        </PageStyled>
