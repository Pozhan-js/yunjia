...
import ic_game from '@/assets/images/Game/mobile/ic_game.png';
...
export default function PlayButton({ }) {
    ...
    return (
        <div>
            ...
            <div>
                <button
                    className=' flex justify-center items-center  w-[2.25rem] h-[2.13rem]  border-[#FFFFFF21] border-[0.125rem]  rounded-[0.63rem] '
                    onClick={() => {
                        handleGotoGame()
                    }}><img className=' w-[1.25rem] h-[0.945rem]' src={ic_game} /></button>
            </div>
            <Modal
                title="Tips"
