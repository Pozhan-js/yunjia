...
export default function GetNft_RewardsSection() {
    ...
    return (
        <Styled className={'flex flex-col items-center mt-[10rem]'}>
                        ...
                        >
                            <div className={'flex flex-col items-start'}>
                                <div className={'flex flex-col items-start'}>
                                    ...
                                    <div className={'text-[1.25rem] text-white mt-4 font-gtwalm'}>{item.title}</div>
                                    <div
                                        className={'mt-[0.87rem] font-normal text-[1rem] text-white text-opacity-60 font-gtwal'}>{item.content}</div>
                                    {/*{*/}
                                    {/*    index === selectIndex && item.goOpenSea &&*/}
                                    {/*    <Button className={'mt-auto'}>Go to Opensea</Button>*/}
                                    {/*}*/}
                                </div>
                                {
                                    item?.goStake &&
                                    ...
                                    //     navigate('/stake')
                                    // }
                                    // } className={'mb-5 mt-[1.81rem]'}>Go to Stake</Button>
                                    <button
                                        onClick={() => {
                                            navigate('/stake')
                                        }}
