...
export default function MorePicks({list}) {
    ...
    return (
        <Styled className={'w-full mx-auto px-9 sm:px-6 md:px-32 pb-[7.5rem]'}>
            <div>
                <p className={'bg-clip-text text-opacity-70 text-white text mt-[4.8rem] text-[2.25rem] font-gtwalmpo font-normal'}>More Picks</p>
            </div>
